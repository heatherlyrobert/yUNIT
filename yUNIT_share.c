...
char
yunit_share__open       (char a_type, char a_label [LEN_TERSE], char a_share, char a_ftype, int a_line, char a_select, char a_desc [LEN_LONG], char a_which [LEN_LABEL], char a_titles [LEN_PATH])
{
   /*---(locals)-----------+-----+-----+-*/
...
char yUNIT_shar              (char a_share, char a_ftype, int a_line, char a_select, char a_desc [LEN_LONG], char a_which [LEN_LABEL], char a_titles [LEN_PATH]) { return yunit_share__open (TYPE_SHARED, "SHARED", a_share, a_ftype, a_line, a_select, a_desc, a_which, a_titles); }
char yUNIT_glob              (char a_share, char a_ftype, int a_line, char a_select, char a_desc [LEN_LONG], char a_which [LEN_LABEL], char a_titles [LEN_PATH]) { return yunit_share__open (TYPE_GLOBAL, "GLOBAL", a_share, a_ftype, a_line, a_select, a_desc, a_which, a_titles); }
char yUNIT_conf              (char a_share, char a_ftype, int a_line, char a_select, char a_desc [LEN_LONG], char a_which [LEN_LABEL], char a_titles [LEN_PATH]) { return yunit_share__open (TYPE_CONFIG, "CONFIG", a_share, a_ftype, a_line, a_select, a_desc, a_which, a_titles); }
