...
char
yunit_disp_show         (int a_line, int a_seqn, char a_share, char a_note [LEN_TERSE], char a_desc [LEN_LONG])
{
   /*---(locals)-----------+-----+-----+-*/
...
char
yunit_disp__top         (char a_type, int a_line, int a_seqn, char a_desc [LEN_LONG], char a_share)
{
   /*---(locals)-----------+-----+-----+-*/
   char        x_line      [LEN_TERSE] = "";
   char        x_seqn      [LEN_TERSE] = "";
...
char
yunit_disp_full         (char a_source, int a_line, int a_seqn, char a_share, char a_desc [LEN_LONG], char a_meth [LEN_HUND], char a_args [LEN_FULL], char a_expe [LEN_RECD], char a_test [LEN_TERSE], char a_actu [LEN_RECD], char a_modd [LEN_RECD])
{
   /*---(locals)-----------+-----+-----+-*/
   ...
   if (a_modd != NULL)  strncpy (x_modd, a_modd, LEN_RECD);
   /*---(create output)------------------*/
   yunit_disp__top (TYPE_STEP, a_line, a_seqn, x_desc, a_share);
...
char
yunit_disp_single       (char a_type, int a_line, int a_seqn, char a_share, char a_desc [LEN_LONG])
{
   /*---(locals)-----------+-----+-----+-*/
   char        x_desc      [LEN_LONG]  = "???";
   /*---(quick-out)----------------------*/
   ...
   if (a_desc != NULL)  strncpy (x_desc, a_desc, LEN_LONG);
   /*---(create output)------------------*/
   yunit_disp__top (a_type, a_line, a_seqn, x_desc, a_share);
   /*---(complete)-----------------------*/
   return 1;
}

char
yunit_disp_double       (char a_type, int a_line, int a_seqn, char a_share, char a_desc [LEN_LONG], char a_label [LEN_TERSE], char a_detail [LEN_RECD])
{
   /*---(locals)-----------+-----+-----+-*/
   char        x_desc      [LEN_LONG]  = "???";
