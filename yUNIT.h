...
char        yUNIT_num               (int a_line, int a_seqn, char a_desc [LEN_LONG], char a_meth [LEN_HUND], char a_args [LEN_FULL], char a_test [LEN_TERSE], int a_expe, int a_actu, char a_exec, char a_dittoing, char a_share);
